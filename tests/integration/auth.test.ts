...
describe('auth', () => {
  ...
  describe('verifyToken', () => {
    it('should return token data for valid Bearer token', async () => {
      const tokenData = { userId: 'u1', username: 'test', email: 't@test.com', role: 'user' as const, createdAt: '2024-01-01' }
  ...
  describe('saveToken & deleteToken', () => {
    it('should save and delete access token with user index', async () => {
      const data = { userId: 'u1', username: 'test', email: 't@test.com', role: 'user' as const, createdAt: '2024-01-01' }
